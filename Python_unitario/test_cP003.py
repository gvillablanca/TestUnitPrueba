...
class TestCP003():
  ...
  def test_cP003(self):
    ...
    self.driver.find_element(By.ID, "codigo").send_keys("S002")
    self.driver.find_element(By.ID, "nombre").click()
    self.driver.find_element(By.ID, "nombre").send_keys("Sierra Corta")
    self.driver.find_element(By.ID, "precio").click()
    self.driver.find_element(By.ID, "precio").send_keys("8522")
    self.driver.find_element(By.ID, "stock").click()
    self.driver.find_element(By.ID, "stock").send_keys("12")
